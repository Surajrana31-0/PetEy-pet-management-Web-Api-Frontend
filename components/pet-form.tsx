        ...
        <CardContent className="space-y-4 p-6">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input id="name" placeholder="Max" aria-invalid={!!errors.name} {...register('name')} />
              {errors.name && <p className="text-xs text-destructive">{errors.name.message}</p>}
            </div>
            <div className="space-y-2">
              <Label htmlFor="age">Age *</Label>
              <Input id="age" placeholder="2 years" aria-invalid={!!errors.age} {...register('age')} />
              {errors.age && <p className="text-xs text-destructive">{errors.age.message}</p>}
            </div>
            <div className="space-y-2">
              <Label htmlFor="breed">Breed *</Label>
              <Input id="breed" placeholder="Golden Retriever" aria-invalid={!!errors.breed} {...register('breed')} />
            ...
            <div className="space-y-2">
              ...
              <Select
                value={species}
                onValueChange={(v) => setValue('species', v as PetSpecies, { shouldValidate: true })}
              >
                <SelectTrigger id="species" aria-invalid={!!errors.species}>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="description"
              rows={4}
              placeholder="Describe the pet's personality, temperament, and care needs (minimum 10 characters)…"
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">Choose an emoji to represent this pet</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={status}
              onValueChange={(v) => setValue('status', v as PetStatus, { shouldValidate: true })}
            >
