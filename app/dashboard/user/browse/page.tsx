    ...
    <div className="dash-page">
      <div className="dash-page-header">
        <div>
          ...
          <p>
            {pets.length > 0
              ? `${pets.length} loving ${pets.length === 1 ? 'companion is' : 'companions are'} waiting for a forever home.`
      ...
      {pets.length === 0 ? (
        <div className="dash-empty">
          ...
          <p className="dash-empty-title">No pets available right now</p>
          <p className="dash-empty-desc">
            Our team is updating listings. Please visit again soon.
          </p>
        </div>
      ) : (
